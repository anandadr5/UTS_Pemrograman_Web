...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fakultass.update", [$fakultas->kode_fakultas]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="kode_fakultas">{{ trans('cruds.fakultas.fields.kode_fakultas') }}</label>
                <input class="form-control {{ $errors->has('kode_fakultas') ? 'is-invalid' : '' }}" type="text" name="kode_fakultas" id="kode_fakultas" value="{{ old('kode_fakultas', $fakultas->kode_fakultas) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fakultas') ? 'is-invalid' : '' }}" type="text" name="fakultas" id="fakultas" value="{{ old('fakultas', $fakultas->fakultas) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('program_studi') ? 'is-invalid' : '' }}" type="text" name="program_studi" id="program_studi" value="{{ old('program_studi', $fakultas->program_studi) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mata_kuliah') ? 'is-invalid' : '' }}" type="text" name="mata_kuliah" id="mata_kuliah" value="{{ old('mata_kuliah', $fakultas->mata_kuliah) }}" required>
