...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Fakultas">
            <thead>
                <tr>
                    <th width="10">
...
@can('fakultas_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fakultass.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fakultass.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Fakultas').DataTable(dtOverrideGlobals);
